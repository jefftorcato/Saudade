(function ($) {
    ...
    db.collection("eventCategory")
        .onSnapshot(function (querySnapshot) {
            querySnapshot.forEach(function (doc) {
                ...
                $("#inputCategory").append('<option value="' + doc.id + '">' + doc.data().name + '</option>');
            });
        })
    ...
    $('#form-addEvent').submit(function (event) {
        ...
        let form_data = {
            artist: uid,
            eventGroup: $('#inputCategory').val(),
            eventLocation: $('#inputEventlocation').val(),
        ...
        uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED, // or 'state_changed'
            ...
            function () {
                ...
                uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                    ...
                    form_data.pathToImage = downloadURL;
                    db.collection("event").add(form_data)
